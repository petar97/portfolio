  ...
  return (
    <div className="w-full h-full relative">
      ...
      >
        ...
        >
          <Image src="${basePath}/assets/port-pic.png" priority quality={100} fill sizes="100%" alt="portfolio picture" className="object-contain rounded-full mix-blend-lighten" />
        </motion.div>
