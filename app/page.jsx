    ...
    <section className="h-full">
      <div className="container mx-auto h-full">
        <div className="flex flex-col xl:flex-row items-center justify-between xl:pt-8 xl:pb-24">
          <AnimatedSection stagger={0.15} delay={2.4} className="text-center xl:text-left order-2 xl:order-none">
            <AnimatedItem as="span" className="text-xl">Software Developer</AnimatedItem>
            <AnimatedItem as="h1" className="h1 mb-6">
              Hello, <br /> I&apos;m <span className="text-accent">Petar Milovanović</span>
            </AnimatedItem>
            <AnimatedItem as="p" className="max-w-[500px] mb-9 text-white/80 mx-auto xl:mx-0">
              I&apos;m a frontend developer focused on creating sleek, responsive, and user-friendly web applications.
            </AnimatedItem>
            <AnimatedItem className="flex items-center gap-8 flex-col xl:flex-row">
              <a
                href="assets/cv.pdf"
                target="_blank"
