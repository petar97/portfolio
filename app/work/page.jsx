                ...
                return <SwiperSlide key={index} className="w-full">
                  <div className="h-[460px] relative group flex justify-center items-center bg-pink-50/20 rounded-2xl">
                    ...
                    <div className="relative w-full h-full">
                      <Image src={project.image} fill quality={80} sizes="(max-width: 1024px) 100vw, 50vw" className="object-cover object-top border border-accent select-none border-4 rounded-2xl" alt={project.title} />
                    </div>
                  </div>
                </SwiperSlide>
              })}
